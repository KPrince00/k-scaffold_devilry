 ...
 */
const environment = {
  attributes:{"sheet_version":"0","devilry_tab":"nav-tabs-devilry--statistics","strength_action":"","strength":"","strength_mod":"","strength_save_action":"","strength_save":"","template_start":"@{whisper}&{template:Devilry_(V1)} {{character_name=@{character_name}}} {{character_id=@{character_id}}}"},
  triggers: [],
  translation,
  otherCharacters: {
...
registerFuncs({ kTabOnOpen },{type:['opener']});
  ...
  const actionAttributes = ["strength_action","strength_save_action"];
